...
DROP STREAM out_votes IF EXISTS;
...
CREATE STREAM out_votes
EXPORT TO TARGET out_votes
PARTITION ON COLUMN phone_number (
  phone_number       bigint     NOT NULL
, state              varchar(2) NOT NULL
, contestant_number  integer    NOT NULL
);
...
LOAD CLASSES ./target/voter-1.0-SNAPSHOT.jar;
